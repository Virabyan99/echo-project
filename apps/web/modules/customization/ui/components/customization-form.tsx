              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea
                      {...field}
                      placeholder="Welcome message shown shown when chat opens"
                      rows={3}
                    />
                  </FormControl>
                  <FormDescription>
                    The fisrs message customers see when they open the chat
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
        ...
        {hasVapiPlugin && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Configure voice voice calling features powered by Vapi
              </CardDescription>
            </CardHeader>

...
import { GlobeIcon, Mail, MonitorIcon } from 'lucide-react'
          ...
          <Accordion
            ...
            {accordionSections.map((section) => (
              <AccordionItem
                ...
                <AccordionTrigger className="flex w-full flex-1 items-start justify-between gap-4 rounded-none bg-accent px-5 py-4 text-left font-medium outline-none transition-all hover:no-underline disabled:pointer-events-none disabled:opacity-50">
